...
@section('title') Business Profiles @endsection
...
@section('content')
    @component('components.breadcrumb')
        @slot('li_1') Business Profiles @endslot
        @slot('title') Business Profiles  @endslot
    @endcomponent
        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <a href="{{ route('business_profiles.create') }}" class="btn btn-primary btn-sm">
...
$(document).ready(function () {
    const table = $('#business-profiles-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '{{ route("business_profiles.get") }}',
        columns: [
