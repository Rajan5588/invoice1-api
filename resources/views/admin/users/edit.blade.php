...
<div class="row justify-content-center">
    <div class="col-lg-11">
        <div class="form-card">
            <h4 class="mb-4"><i class="bi bi-pencil-square me-2"></i> Edit User</h4>
            ...
            <form action="{{ route('users.update', $user->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="company_code" class="form-control select2 @error('company_code') is-invalid @enderror">
                            ...
                            @foreach($companies as $company)
                                <option value="{{ $company->company_code }}" {{ old('company_code', $user->company_code) == $company->company_code ? 'selected' : '' }}>
                ...
                <div class="row g-4">
                    <div class="col-md-12">
                        ...
                        <textarea name="full_address" rows="2" class="form-control @error('full_address') is-invalid @enderror">{{ old('full_address', $user->full_address) }}</textarea>
                ...
                <div class="row g-4 align-items-center">
                    ...
                    <div class="col-md-6 text-center">
                        <img id="preview" src="{{ $user->avatar ? asset('storage/'.$user->avatar) : 'https://via.placeholder.com/120' }}" class="preview-img" alt="Preview">
                    </div>
                </div>
