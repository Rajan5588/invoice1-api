...
?>
  ...
  <div class="invoice-box">
    ...
    <div class="company-info">
      <h2><?php echo e($businessProfile->business_name ?? 'Company Name'); ?></h2>
      <p><?php echo e($businessProfile->business_address ?? ''); ?>, 
         <?php echo e($businessProfile->city ?? ''); ?> - <?php echo e($businessProfile->pincode ?? ''); ?></p>
      <p>GSTIN : <?php echo e($businessProfile->gst_no ?? '-'); ?>

        <span class="state-code-box">State Code : <?php echo e($businessProfile->state_code ?? '-'); ?></span>
      </p>
      <p>Call: <?php echo e($businessProfile->phone_no_first ?? '-'); ?> | Email: <?php echo e($businessProfile->business_email ?? $businessProfile->email ?? '-'); ?></p>
    </div>
      ...
      <div class="left">
        <table>
          <tr>
            ...
            <td>: <?php echo e($invoice->invoice_number ?? $invoice->id); ?></td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td>: <?php echo e($invoice->billingDetail->state ?? '-'); ?></td>
          </tr>
          <tr>
      ...
      <div class="right">
        <table>
          <tr>
            ...
            <td style="text-align:right;"><?php echo e($invoice->user->sname ?? '-'); ?></td>
          </tr>
        </table>
      </div>
    </div>
    ...
    <div class="address-section">
      <div class="address-box">
        ...
        <p><span class="bold">Name:</span> <?php echo e($invoice->billingDetail->name ?? '-'); ?></p>
        <p><span class="bold">Address:</span> <?php echo nl2br(e($invoice->billingDetail->address ?? '-')); ?></p>
        <p><span class="bold">GSTIN:</span> <?php echo e($invoice->billingDetail->gst_number ?? '-'); ?>

          <span class="state-code-box">State Code : <?php echo e($invoice->billingDetail->state_code ?? '-'); ?></span>
        </p>
        <p><span class="bold">State:</span> <?php echo e($invoice->billingDetail->state ?? '-'); ?></p>
      </div>
      ...
      <div class="address-box">
        ...
        <p><span class="bold">Address:</span> <?php echo nl2br(e($invoice->shippingDetail->address ?? '-')); ?></p>
        <p><span class="bold">GSTIN:</span> <?php echo e($invoice->shippingDetail->gst_number ?? '-'); ?>

          <span class="state-code-box">State Code : <?php echo e($invoice->shippingDetail->state_code ?? '-'); ?></span>
        </p>
        <p><span class="bold">State:</span> <?php echo e($invoice->shippingDetail->state ?? '-'); ?></p>
      </div>
    </div>
...
<table class="product-table">
  ...
  <?php $__currentLoopData = $invoice->gstDetails; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $gst): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <tr>
      <td><?php echo e($sr++); ?></td>
      <td class="text-left"><?php echo e($invoiceItem->item->item_name ?? '-'); ?></td>
      <td><?php echo e($gst->quantity); ?></td>
      <td>PCS</td>
      <td><?php echo e(number_format($gst->price,2)); ?></td>
      <td class="highlight"><?php echo e(number_format($taxable,2)); ?></td>
  ...
  <tr>
    ...
    <td colspan="2"></td>
    <td class="highlight">₹ <?php echo e(number_format($totalTaxable,2)); ?></td>
    <td></td>
    <td>₹ <?php echo e(number_format($totalIGST,2)); ?></td>
...
<table class="summary-table">
  <tr>
    <td rowspan="6" style="width: 60%;">
      ...
      <span style="font-weight: bold;"><?php echo e(numberToWordsIndian($grandTotal)); ?></span>
    </td>
  ...
  <tr>
    ...
    <td>₹ <?php echo e(number_format($totalCGST+$totalSGST+$totalIGST,2)); ?></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td>₹ <?php echo e(number_format($grandTotal - ($invoice->amount_received ?? 0),2)); ?></td>
  </tr>
</table>
    ...
    <div class="footer-sign">
      ...
      <strong>For, <?php echo e($businessProfile->business_name ?? 'Company Name'); ?></strong>
    </div>

    <div class="sign-box">
      <div><img src="<?php echo e(asset($businessProfile->business_signature ?? '')); ?>" alt=""></div>
...
<?php /**PATH /home2/acttconnect/new-invoice.acttconnect.com/resources/views/admin/invoices/bill.blade.php ENDPATH**/ ?>