...
<div class="app-menu navbar-menu">
    <div class="navbar-brand-box" style="background-color:#ffff;">
        <a href="<?php echo e(route('root')); ?>" class="logo logo-dark">
            <span class="logo-sm"><img src="<?php echo e(URL::asset('build/images/logonewsrgi.png')); ?>" height="34"></span>
            <span class="logo-lg"><img src="<?php echo e(URL::asset('build/images/logonewsrgi.png')); ?>" height="72"></span>
        </a>
    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <!-- Billing -->
                <?php if($permissions['invoices']['view'] || $permissions['transactions']['view']): ?>
                <li class="nav-item">
                ...
                <!-- Items -->
                <?php if($permissions['items']['view'] || $permissions['item_categories']['view']): ?>
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="itemsMenu">
                        <ul class="nav nav-sm flex-column">
                            <?php if($permissions['item_categories']['view']): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('item_categories.index')); ?>">Items Category</a></li>
                            <?php endif; ?>
                            <?php if($permissions['items']['view']): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('items.index')); ?>">Items List</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </li>
                ...
                <!-- Business -->
                <?php if($permissions['business_profiles']['view'] || $permissions['company']['view'] || $permissions['roles_permissions']['view']): ?>
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="businessMenu">
                        <ul class="nav nav-sm flex-column">
                            <?php if($permissions['business_profiles']['view']): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('business_profiles.index')); ?>">Businesses</a></li>
                            <?php endif; ?>
                            <?php if($permissions['company']['view']): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('company.index')); ?>">Companies</a></li>
                            <?php endif; ?>
                            <?php if($permissions['roles_permissions']['view']): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('roles.index')); ?>">Roles</a></li>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('permissions.index')); ?>">Permissions</a></li>
                            <?php endif; ?>
                            
                          <?php if($permissions['customers']['view']): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('admin-customers.index')); ?>">Customers</a></li>
                            <?php endif; ?>
                        </ul>
                    </div>
                </li>
                ...
                <!-- Subscriptions -->
                <?php if($permissions['subscriptions']['view'] || $permissions['coupons']['view']): ?>
                <li class="nav-item">
                    ...
                    <div class="collapse menu-dropdown" id="subscriptionsMenu">
                        <ul class="nav nav-sm flex-column">
                            <?php if($permissions['subscriptions']['view']): ?>
                            <li class="nav-item"><a class="nav-link" href="<?php echo e(route('subscriptions.index')); ?>">Subscriptions</a></li>
                            <?php endif; ?>
                            <?php if($permissions['coupons']['view']): ?>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="<?php echo e(route('admin-expenses.index')); ?>">
...
<!--        <div class="collapse menu-dropdown" id="billingMenu">-->
<!--            <ul class="nav nav-sm flex-column">-->
<!--                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('invoices.index')); ?>">All  Bill</a></li>-->
<!--                <li class="nav-item"><a class="nav-link" href="<?php echo e(route('transactions.index')); ?>">Transactions</a></li>-->
<!--            </ul>-->
<!--        </div>-->
<!--    </li>-->
...
<?php /**PATH /home2/acttconnect/new-invoice.acttconnect.com/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>