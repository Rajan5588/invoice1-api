...
<?php $__env->startComponent('components.breadcrumb'); ?>
    <?php $__env->slot('li_1'); ?> Expenses <?php $__env->endSlot(); ?>
    <?php $__env->slot('title'); ?> Expenses <?php $__env->endSlot(); ?>
...
$(document).ready(function () {
    let table = $('#expenses-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route("admin-expenses.index", $company_slug)); ?>',
        columns: [
    ...
    $(document).on('click', '.editExpense', function () {
        let id = $(this).data('id');
        $.get("<?php echo e(url($company_slug.'/admin-expenses')); ?>/" + id + "/edit", function (data) {
            ...
            if (data.photos && data.photos.length > 0) {
                data.photos.forEach(function(photo) {
                    $('#previewImages').append(
                        '<img src="<?php echo e(asset("assets/expenses")); ?>/'+photo+'" class="rounded border" style="width:100px; height:100px; object-fit:cover;">'
                    );
                });
            }
    ...
    $('#expenseForm').submit(function (e) {
        ...
        let url = id ? "<?php echo e(url($company_slug.'/admin-expenses')); ?>/" + id : "<?php echo e(route('admin-expenses.store', $company_slug)); ?>";
...
$(document).on('click', '.sa-warning', function (e) {
    ...
    $(document).on('change', '.changeStatus', function () {
        ...
        $.post("<?php echo e(url($company_slug.'/admin-expenses')); ?>/" + id + "/status", { status: statusVal }, function (response) {
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/new-invoice.acttconnect.com/resources/views/admin/Expences/index.blade.php ENDPATH**/ ?>