...
<?php $__env->startSection('title'); ?> Item Categories <?php $__env->stopSection(); ?>
...
<?php $__env->startComponent('components.breadcrumb'); ?>
    <?php $__env->slot('li_1'); ?> Item Categories <?php $__env->endSlot(); ?>
    <?php $__env->slot('title'); ?> Item Categories  <?php $__env->endSlot(); ?>
...
<div class="row">
    ...
    <div class="col-xl-4 col-lg-6">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?php echo e(route('categories.store', $company_slug)); ?>" method="POST">
                    <?php echo csrf_field(); ?>
                    <div class="mb-3">
...
$(document).ready(function () {
    ...
    const table = $('#item-categories-table').DataTable({
        processing: true,
        serverSide: true,
        ajax: '<?php echo e(route("item_categories.get", $company_slug)); ?>',
        columns: [
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/new-invoice.acttconnect.com/resources/views/admin/items/item-category/index.blade.php ENDPATH**/ ?>