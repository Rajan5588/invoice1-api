...
<div class="row">
    ...
    <div class="d-flex align-items-center">
        <!-- Filter Dropdown -->
        <div id="users-filter" class="me-2">
        ...
        <a href="<?php echo e(route('users.create')); ?>" class="btn btn-primary btn-sm">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table class="table table-bordered dt-responsive nowrap table-striped align-middle" id="users-table" style="width:100%">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Action</th>
...
$(document).ready(function () {
    const table = $('#users-table').DataTable({
        ...
        serverSide: true,
        ajax: {
            url: '<?php echo e(route("users.get")); ?>',
            data: function(d) {
                d.filter = $('#filter').val();
            }
        },
        ...
        dom: "<'d-flex justify-content-between mb-2'B<'#users-filter'>f>rtip",
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home2/acttconnect/new-invoice.acttconnect.com/resources/views/admin/users/index.blade.php ENDPATH**/ ?>